...
//************************************************************************************************
boolean xbeeATst::sendLocalAtCommand(char* _ATcommand) {
...
boolean xbeeATst::sendLocalAtCommandWithOptions (char* _ATcommand, char* _AToptions,int _optionsize) {
...
//************************************************************************************************
boolean xbeeATst::getLocalATCommandData(int _timeOut){
...
//************************************************************************************************
boolean xbeeATst::sendAtCommandWithOptions (long* _destination, char* _ATcommand, char* _AToptions,int _optionsize, int _localAddress ) {
...
//************************************************************************************************
boolean xbeeATst::sendAtCommand(long* _destination, char* _ATcommand, int _localAddress ) {
...
//************************************************************************************************
boolean xbeeATst::getATCommandData(int _timeOut){
